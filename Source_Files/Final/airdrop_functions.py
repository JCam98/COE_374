'''Description: This python module contains all of the functions needed 
to evaluate and store waypoints for an optimized trajectory of motion
to drop payloads given a text file with identification types and GPS 
coordinates provided by the Image Processing Team.'''
