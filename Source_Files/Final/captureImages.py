''' Description: The function, "mapImages()" in this script is used to capture live video
of the field during the cruise out phase for the purpose of storing associated 
image frames to stitch together for the published map. This function is invoked in "main.py" '''
